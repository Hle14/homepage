...
btn-home.onclick = function(){portrait.src='gnome.png'};
btn-projects.onclick = function(){portrait.src='SC_cat.jpg'};
btn-blog.onclick = function(){portrait.src='shyguy_avatar.jpg'};
